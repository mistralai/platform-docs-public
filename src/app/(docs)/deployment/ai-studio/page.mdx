...
- **AI Studio** previously "La Plateforme": We provide API endpoints through [AI Studio][platform_url] providing pay-as-you-go access to our latest models.
...
<SectionTab as="h1" sectionId="api-access-with-the-la-plateforme">API Access with the La Plateforme</SectionTab>
