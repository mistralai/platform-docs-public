...
:::tip
For document parsing, OCR, and data extraction, see [Document Processing](/studio-api/document-processing/overview).
:::
...
:::note
These are simple examples you can use as inspiration to build your own use cases. For OCR and structured outputs, see [Document Processing](/studio-api/document-processing).
:::
