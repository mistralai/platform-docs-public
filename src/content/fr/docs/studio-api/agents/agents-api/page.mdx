...
:::info[Accès aux conversations]
L’API Conversations publique ne peut lire ni modifier que les conversations appartenant au créateur de la clé API utilisée dans la requête.
:::
