...
- **[Guide de démarrage](search-toolkit/quickstart)** — créez votre première pipeline d’ingestion et de recherche de bout en bout.
- **[Index de recherche](search-toolkit/search-index)** — configurez votre base de vecteurs.
- **[Ingestion](search-toolkit/ingestion)** — chargez, extrayez, fragmentez, enrichissez et indexez vos documents.
- **[Recherche](search-toolkit/retrieval)** — configurez la recherche vectorielle avec un reranking optionnel.
