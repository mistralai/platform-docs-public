...
:::tip
Before continuing, we recommend reading the [Chat Completions](/capabilities/completion) documentation to learn more about the chat completions API and how to use it before proceeding.
:::
