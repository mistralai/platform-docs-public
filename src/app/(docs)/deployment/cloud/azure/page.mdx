...
# Azure AI
Our open and commercial models can be deployed on the Microsoft Azure AI cloud platform in two ways:
...
Deployed endpoints expose a REST API that you can query using our SDKs, HTTPS calls, and in some cases the Microsoft Foundry SDK.
