...
:::info
Le chiffrement peut être combiné avec l’[externalisation des payloads](/studio-api/workflows/building-workflows/payload_offloading) et la [compression](/studio-api/workflows/building-workflows/compression). Les payloads sont compressés et externalisés avant le chiffrement, qui intervient en dernier, si bien que l’orchestrateur ne voit jamais qu’une référence chiffrée.
:::
