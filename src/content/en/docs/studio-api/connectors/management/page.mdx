...
1. **Test** the MCP server in the [Connectors Debugger](/studio-api/connectors/debugger) if you want to validate connectivity first.
...
5. **Use** the Connector in [conversations](/studio-api/connectors/conversations) or via [direct tool calls](/studio-api/connectors/tool_calling).
...
List the tools a Connector exposes. This helps verify available tool names before using them in [conversations](/studio-api/connectors/conversations) or [calling them directly](/studio-api/connectors/tool_calling).
