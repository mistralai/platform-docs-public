...
Voir [Consommer des événements en streaming > Consommer les événements d'arbres de workflows](/studio/workflows/building-workflows/consuming_events#consuming-events-from-workflow-trees) pour le schéma d'abonnement.
