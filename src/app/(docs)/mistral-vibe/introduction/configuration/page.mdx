...
:::tip
You can get your Mistral API key from the [Mistral console](https://console.mistral.ai/codestral/vibe).
...
:::note
This implies that you've set up a redteam prompt named `~/.vibe/prompts/redteam.md`.
:::

<SectionTab as="h1" sectionId="change-providers">Change Providers and Models</SectionTab>

You can change the providers and models behind Vibe by editing the `config.toml` file as follows:
