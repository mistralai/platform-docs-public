...
Notez que le contenu de la réponse du modèle peut contenir des **événements entrelacés** au lieu d'une seule chaîne de caractères, tels que des [citations](/studio/conversations/citations) et des [appels d'outils](/studio/conversations/function-calling).  
