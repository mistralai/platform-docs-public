...
:::note
For heavier document processing needs (structured extraction from scanned PDFs, multi-page forms, or handwritten content in bulk), check Studio's [Document Processing](/studio-api/document-processing) features.
:::
