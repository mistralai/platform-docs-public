...
:::info
When enabled, Deep Research uses [Flash Answers](/le-chat/conversation/flash-answers) for fast text generation, producing over 1,000 tokens (roughly 750 words) per second.
:::
...
- **[Flash Answers](/le-chat/conversation/flash-answers)**: fast, concise answers for simpler questions.
