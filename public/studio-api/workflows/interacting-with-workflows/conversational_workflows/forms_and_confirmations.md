...
<figure>
  <Image
    ...
    alt="A structured form input rendered in Vibe Work."
    centered
  />
  <legend className="text-sm text-gray-500 text-center italic">A structured form input rendered in Vibe Work.</legend>
</figure>
...
<figure>
  <Image
    ...
    alt="A text field rendered in Vibe Work."
    centered
  />
  <legend className="text-sm text-gray-500 text-center italic">Text field in Vibe Work.</legend>
</figure>
...
<figure>
  <Image
    ...
    alt="A number field rendered in Vibe Work."
    centered
  />
  <legend className="text-sm text-gray-500 text-center italic">Number field in Vibe Work.</legend>
</figure>
...
<figure>
  <Image
    ...
    alt="A date-time picker field rendered in Vibe Work."
    centered
  />
  <legend className="text-sm text-gray-500 text-center italic">Date-time field in Vibe Work.</legend>
</figure>
...
<figure>
  <Image
    ...
    alt="A date picker field rendered in Vibe Work."
    centered
  />
  <legend className="text-sm text-gray-500 text-center italic">Date field in Vibe Work.</legend>
</figure>
...
<figure>
  <Image
    ...
    alt="A single-choice dropdown rendered in Vibe Work, showing priority options."
    centered
  />
  <Image
    url="/img/conversational_workflows/conversational-workflow_single-choice-field_status.png"
    alt="A single-choice dropdown rendered in Vibe Work, showing status options."
    centered
  />
  <legend className="text-sm text-gray-500 text-center italic">Single-choice field in Vibe Work.</legend>
</figure>
...
<figure>
  <Image
    ...
    alt="A multi-choice field rendered in Vibe Work, showing tag options."
    centered
  />
  <Image
    url="/img/conversational_workflows/conversational-workflow_multi-choice-field_colors.png"
    alt="A multi-choice field rendered in Vibe Work, showing color options."
    centered
  />
  <legend className="text-sm text-gray-500 text-center italic">Multi-choice field in Vibe Work.</legend>
</figure>
...
<figure>
  <Image
    ...
    alt="A single file upload field rendered in Vibe Work."
    centered
  />
  <Image
    url="/img/conversational_workflows/conversational-workflow_file-field_attachements.png"
    alt="A multiple file upload field rendered in Vibe Work, showing attached files."
    centered
  />
  <legend className="text-sm text-gray-500 text-center italic">File upload field in Vibe Work.</legend>
</figure>
...
<figure>
  <Image
    ...
    alt="A confirmation input rendered in Vibe Work, showing buttons for each option."
    centered
  />
  <legend className="text-sm text-gray-500 text-center italic">Confirmation input in Vibe Work.</legend>
</figure>
...
<figure>
  <Image
    ...
    alt="An accept/decline confirmation rendered in Vibe Work, showing two buttons for accept and decline."
    centered
  />
  <legend className="text-sm text-gray-500 text-center italic">Accept/decline confirmation in Vibe Work.</legend>
</figure>
