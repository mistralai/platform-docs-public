...
As previously mentioned, you can start a conversation at any point with your custom Agent or with a specific model of your choice.
...
Without an Agent, starting a Conversation looks like this:
