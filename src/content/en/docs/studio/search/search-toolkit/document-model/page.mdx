...
- **[Ingestion](/studio/search-toolkit/ingestion)**: how documents and chunks are produced.
- **[Retrieval](/studio/search-toolkit/retrieval)**: how chunks are searched and returned.
- **[Search index](/studio/search-toolkit/search-index)**: how chunks are persisted.
