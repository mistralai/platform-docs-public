...
- **[Ingestion](/studio/search/search-toolkit/ingestion)**: how documents and chunks are produced.
- **[Retrieval](/studio/search/search-toolkit/retrieval)**: how chunks are searched and returned.
- **[Search index](/studio/search/search-toolkit/search-index)**: how chunks are persisted.
