...
View your current rate limits at <AppLink href="https://admin.mistral.ai/plateforme/limits" path={["Admin Panel", "API", "Limits"]} />. For more details, see [Usage and limits](/admin/billing-usage/usage-limits).
