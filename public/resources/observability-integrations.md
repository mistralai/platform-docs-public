...
sidebar_position: 5
description: Integrate Mistral with third-party observability tools to monitor, trace, and evaluate your LLM applications.
---
...
- **Annotation**
  - Manual or automated annotations added to the output for further analysis and potentially added to the evaluation dataset.
...
Weights & Biases is an end-to-end AI developer platform for ML and LLM workflows. Use W&B Weave to evaluate, monitor, and iterate on GenAI applications, and W&B Models as a system of record to train and manage AI models.

<img src="/img/guides/obs_wandb.png" alt="drawing" width="700"/>

**Pros:**

- Platform for LLM app development and ML workflows
...
To get you started, check the [cookbook](https://github.com/mistralai/cookbook/tree/main/third_party/wandb).
