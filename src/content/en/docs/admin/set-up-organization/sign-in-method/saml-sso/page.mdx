...
Configure automatic seat assignment from <AppLink href="https://admin.mistral.ai/organization/access" path={["Admin Panel", "Administration", "Access"]} />.
...
You can disable SSO at any time from <AppLink href="https://admin.mistral.ai/organization/access" path={["Admin Panel", "Administration", "Access"]} /> in the Admin Panel.
