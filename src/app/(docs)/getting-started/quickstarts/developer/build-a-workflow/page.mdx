...
With the worker running, open a second terminal and trigger an execution:
...
3. Click **Start Workflow** and pass `{"name": "your name"}` as input.
...
```json
{
  "result": "Hello, your name! Welcome to Mistral Workflows."
}
```
