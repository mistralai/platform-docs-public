...
The [SDK](/resources/sdks) lets you **create and monitor Campaigns from code**. Useful for scheduled quality checks, automated alerting pipelines, or CI/CD integration.
