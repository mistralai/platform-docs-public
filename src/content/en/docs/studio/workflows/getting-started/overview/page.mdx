...
For details, see [Payload offloading](/studio/workflows/building-workflows/payload_offloading) and [Encryption](/studio/workflows/building-workflows/encryption).
:::
...
|------|------|
| Install the SDK | [Installation](/studio/workflows/getting-started/installation) |
| See a working workflow in 5 minutes | [Your First Workflow](/studio/workflows/getting-started/your_first_workflow) |
| Understand how the pieces fit together | [Core concepts](/studio/workflows/getting-started/core_concepts) |
| Build an LLM agent inside a workflow | [Durable Agents](/studio/workflows/building-workflows/durable_agents) |
| Schedule a recurring workflow | [Scheduling](/studio/workflows/building-workflows/scheduling) |
