...
<SectionTab as="h2" variant="secondary" sectionId="benefits-of-prompting">Avantages du Prompting</SectionTab>
  ...
  Consultez notre [documentation sur le prompting](/models/best-practices/prompt-engineering) pour explorer différentes méthodes de prompting permettant d'exploiter les modèles Mistral.
...
- [Fine-tuning général texte et vision](/resources/deprecated/finetuning/text_vision_finetuning) via SFT : Supervised Fine-tuning, la méthode de fine-tuning la plus courante pour enseigner au modèle des connaissances et comment suivre des instructions.
