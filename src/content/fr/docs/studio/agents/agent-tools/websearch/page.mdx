...
Notre [outil](/studio/agents/agent-tools#built-in-tools) intégré pour la recherche web permet à n'importe lequel de nos modèles d'accéder au web à tout moment pour rechercher des sites et des sources d'informations pertinentes afin de répondre à la requête donnée.
...
Un autre outil qui utilise les références est l'outil Document Library. Pour plus de détails, consultez le [guide des bibliothèques](/studio/search/libraries#connecting-libraries-to-agents).
Pour en savoir plus sur les citations, consultez le [guide des citations](/studio/conversations/citations).
