...
:::tip
To restrict which API keys can register workflows in a deployment, see [Hardened deployments](/studio/workflows/managing-workflows-in-production/hardened_deployments).
:::
