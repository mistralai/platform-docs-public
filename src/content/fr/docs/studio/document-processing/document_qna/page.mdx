...
:::tip
Avant de continuer, nous vous recommandons de lire la documentation [Chat Completions](/studio/conversations/chat-completion) pour en savoir plus sur l'API de chat completions et son utilisation.
:::
