...
Les activités sont les unités de travail d’un workflow. Pour un aperçu conceptuel (atomicité, reprises, relecture), consultez [Concepts de base > Activités](/studio/workflows/getting-started/core_concepts/activities). Cette page explique comment les définir, les configurer et les structurer.
...
[En savoir plus sur l’observabilité et la gestion des noms](/studio/workflows/observability)
...
Cette sous-section fait référence pour le comportement des heartbeats ; les sections [Concepts de base > Activités](/studio/workflows/getting-started/core_concepts/activities#long-running-activities-heartbeats) et [Concepts de base > Workers](/studio/workflows/getting-started/core_concepts/workers) renvoient ici.

:::note
Non pris en charge pour les [activités locales](/studio/workflows/building-workflows/activities/local_activities).
:::
