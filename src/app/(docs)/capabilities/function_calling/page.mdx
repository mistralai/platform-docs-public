...
<SectionTab as="h1" sectionId="chat-completion">Available Models</SectionTab>
...
<SectionTab as="h3" variant="secondary" variant="secondary" sectionId="tool-choice">Tool Choice</SectionTab>
...
<SectionTab as="h3" variant="secondary" variant="secondary" sectionId="parallel-tool-calls">Parallel Tool Calls</SectionTab>
