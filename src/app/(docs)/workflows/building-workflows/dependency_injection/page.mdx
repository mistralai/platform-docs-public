...
<SectionTab as="h2" variant="secondary" sectionId="dependency-lifecycle-and-resource-sharing">Dependency Lifecycle and Resource Sharing</SectionTab>
...
<SectionTab as="h2" variant="secondary" sectionId="database-connections">Database Connections</SectionTab>
...
<SectionTab as="h2" variant="secondary" sectionId="api-clients">API Clients</SectionTab>
