...
| Mistral Moderation 2 | | :heavy_check_mark: | Our latest moderation model with 128k context, jailbreaking detection, and improved multilingual performance | 128k  | `mistral-moderation-2603` | 26.03|
...
- `mistral-moderation-latest`: currently points to `mistral-moderation-2603`.
...
| Devstral Medium | | `devstral-medium-2507` | 25.07 | 2026/02/27 | 2026/05/31 | `devstral-latest` |
| Mistral OCR 2505 | | `mistral-ocr-2505` | 25.05 | 2026/02/27 | 2026/05/31 | `mistral-ocr-latest` |
| Mistral Large 2.1 | :heavy_check_mark: <br/> [Mistral Research License](https://mistral.ai/licenses/MRL-0.1.md) | `mistral-large-2411` | 24.11 | 2026/02/27 | 2026/05/31 | `mistral-large-latest` |
| Pixtral Large | :heavy_check_mark: <br/> [Mistral Research License](https://mistral.ai/licenses/MRL-0.1.md) | `pixtral-large-2411` | 24.11 | 2026/02/27 | 2026/05/31 | `mistral-large-latest` |
| Devstral Small Labs | | `labs-devstral-small-2512` | 25.12 | 2026/02/27 | 2026/03/31 | `devstral-latest` |
| Devstral Small 1.1 | :heavy_check_mark: <br/> Apache2 | `devstral-small-2507` | 25.07 | 2026/02/27 | 2026/05/31 | `devstral-latest` |
| Voxtral Mini | :heavy_check_mark: <br/> Apache2 | `voxtral-mini-2507` | 25.07 | 2026/02/27 | 2026/05/31 | `voxtral-mini-latest` |
| Mistral Small Creative | | `labs-mistral-small-creative` | | TBD | 2026/04/30 | `open-mistral-nemo` |
| Mistral Moderation | | `mistral-moderation-2411` | 24.11 | TBD | 2026/06/30 | `mistral-moderation-2603` |