...
- Set the following environment variables:
  ...
  - _(V1 only)_ `GOOGLE_CLOUD_REGION`: The target cloud region.
  - _(V1 only)_ `GOOGLE_CLOUD_PROJECT_ID`: The name of your project.
...
For more information, see the [Codestral model card](/models/model-cards/codestral-2508).
