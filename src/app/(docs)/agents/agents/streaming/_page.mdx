...
You can also stream outputs when starting, continuing, or restarting a conversation.
<Tabs groupId="code">
...
When streaming, you'll receive specific event types for different content. These include:
