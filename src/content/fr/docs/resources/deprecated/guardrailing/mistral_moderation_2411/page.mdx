...
:::warning 
**Obsolète** : `mistral-moderation-2411` est obsolète. Migrez vers [`mistral-moderation-2603`](/studio/safety-moderation) et mettez à jour vos configurations de garde-fous `moderation_llm_v1` vers `moderation_llm_v2`.
:::
