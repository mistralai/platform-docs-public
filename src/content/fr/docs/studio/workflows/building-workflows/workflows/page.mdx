...
Cette page présente les schémas pratiques pour concevoir des workflows. Pour mieux comprendre la logique sous-jacente (durabilité, relecture, historique, déterminisme), consultez [Concepts clés > Workflows](/studio/workflows/getting-started/core_concepts/workflows).
...
Pour la contrepartie « activité » de cette page, voir [Activités](/studio/workflows/building-workflows/activities).
...
Pour le rôle et la valeur par défaut de `execution_timeout`, voir [Concepts clés > Timeout d’exécution](/studio/workflows/getting-started/core_concepts/workflows#execution-timeout). Pour modifier la valeur par défaut (1h), transmettez un `timedelta` au décorateur :
...
[Plus d’informations sur les signaux](/studio/workflows/interacting-with-workflows/signals)
...
[Plus d’informations sur les requêtes](/studio/workflows/interacting-with-workflows/queries)
...
[Plus d’informations sur les mises à jour](/studio/workflows/interacting-with-workflows/updates)
...
[Plus d’informations sur la planification](/studio/workflows/building-workflows/scheduling)
...
Pour le schéma complet (paramètres d’état, déclencheur, implications sur le déterminisme), voir [Continue-as-new](/studio/workflows/building-workflows/continue_as_new).
