...
Image Generation is a built-in [tool](/studio-api/agents/agent-tools#built-in-tools) that enables agents to generate images of all kinds and forms.
...
<SectionTab as="h1" sectionId="create-an-image-generation-agent">Create an Image Generation Agent</SectionTab>
...
<SectionTab as="h2" variant="secondary" sectionId="conversation-with-image-generation">Conversations with Image Generation</SectionTab>
...
<SectionTab as="h2" variant="secondary" sectionId="explanation-of-the-outputs">Explanation of the Outputs</SectionTab>
...
<SectionTab as="h2" variant="secondary" sectionId="download-images">Download Images</SectionTab>
