...
:::info
Want to encrypt or compress payloads in addition to offloading them? See [Encryption](/studio/workflows/building-workflows/encryption) and [Compression](/studio/workflows/building-workflows/compression). All three features can be combined. Compression runs first and can pull a payload back under the 2MB limit, skipping offloading entirely.
:::
