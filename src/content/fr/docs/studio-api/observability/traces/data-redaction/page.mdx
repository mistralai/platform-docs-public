...
Les traces de conversation Vibe Work sont masquées avec la politique par défaut avant de quitter l'infrastructure de Mistral. Dans le service hébergé par Mistral, cela est géré pour vous et n'est pas configurable. Dans un déploiement dédié, le niveau de masquage est défini pour l'ensemble du déploiement.
