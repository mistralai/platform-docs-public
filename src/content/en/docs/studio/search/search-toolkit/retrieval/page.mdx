...
- **[Retrievers](/studio/search/search-toolkit/retrieval/retrievers)**: VectorRetriever, KeywordRetriever, and hybrid search patterns
- **[Rerankers](/studio/search/search-toolkit/retrieval/rerankers)**: LLMReRanker, CrossEncoderReRanker, RRF fusion, and custom rerankers
- **[Query preprocessing](/studio/search/search-toolkit/retrieval/preprocessing)**: Query rewriting and expansion for better retrieval quality
- **[Semantic cache](/studio/search/search-toolkit/retrieval/semantic-cache)**: Cache results by query similarity to reduce latency
