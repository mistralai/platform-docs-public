...
<figure>
  <Image
    ...
    alt="Une entrée de formulaire structurée affichée dans Vibe Work."
    centered
  />
  <legend className="text-sm text-gray-500 text-center italic">Une entrée de formulaire structurée affichée dans Vibe Work.</legend>
</figure>
...
<figure>
  <Image
    ...
    alt="Un champ de texte affiché dans Vibe Work."
    centered
  />
  <legend className="text-sm text-gray-500 text-center italic">Champ de texte dans Vibe Work.</legend>
</figure>
...
<figure>
  <Image
    ...
    alt="Un champ de sélection de date et d’heure affiché dans Vibe Work."
    centered
  />
...
<figure>
  <Image
    ...
    alt="Un menu déroulant à choix unique affiché dans Vibe Work, avec des options de priorité."
    centered
  />
  <Image
    url="/img/conversational_workflows/conversational-workflow_single-choice-field_status.png"
    alt="Un menu déroulant à choix unique affiché dans Vibe Work, avec des options de statut."
    centered
  />
...
<figure>
  <Image
    ...
    alt="Un champ à choix multiple affiché dans Vibe Work, avec des options de tags."
    centered
  />
  <Image
    url="/img/conversational_workflows/conversational-workflow_multi-choice-field_colors.png"
    alt="Un champ à choix multiple affiché dans Vibe Work, avec des options de couleur."
    centered
  />
...
<figure>
  ...
  <Image
    ...
    alt="Un champ de téléchargement de plusieurs fichiers affiché dans Vibe Work, avec les fichiers joints."
    centered
  />
...
<figure>
  <Image
    ...
    alt="Une entrée de confirmation affichée dans Vibe Work, avec un bouton pour chaque option."
    centered
  />
