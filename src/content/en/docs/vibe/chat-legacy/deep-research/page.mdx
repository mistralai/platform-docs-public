...
:::warning
Deep Research has been sunset in the **Chat** tab. Starting a Deep Research in Chat now redirects you to the **Work** tab with the [Deep Research Skill](/vibe/work/skills) already selected.

Deep Research is still available as a [Skill](/vibe/work/skills) in the Work tab, where it works with [Connectors](/vibe/work/connectors) and [Canvas](/vibe/work/files-and-canvas). This is part of the ongoing unification of the Chat and Work tabs.
:::
