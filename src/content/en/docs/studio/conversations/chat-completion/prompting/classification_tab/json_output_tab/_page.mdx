...
:::tip
You can use the `response_format` parameter to force the model to answer with a json object, or even enforce a specific json schema. Visit our [Structured Outputs](/studio/conversations/structured-output) documentation for further details.
:::
