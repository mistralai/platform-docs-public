...
function NavigationMenuContent({
  ...
  return (
    <NavigationMenuPrimitive.Content
      ...
      className={cn(
        'data-[motion^=from-]:animate-in data-[motion^=to-]:animate-out data-[motion^=from-]:fade-in data-[motion^=to-]:fade-out data-[motion=from-end]:slide-in-from-right-1 data-[motion=from-start]:slide-in-from-left-1 data-[motion=to-end]:slide-out-to-right-1 data-[motion=to-start]:slide-out-to-left-1 duration-150 ease-[cubic-bezier(0,0,0,1)] top-0 left-0 w-full p-2 pr-2.5 md:absolute md:w-auto',
    ...
    >
      <NavigationMenuPrimitive.Viewport
        ...
        className={cn(
          ...
          'data-[state=open]:animate-nav-clip-in data-[state=closed]:animate-nav-clip-out',
...
function NavigationMenuLink({
  ...
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        "data-[active=true]:focus:bg-accent data-[active=true]:hover:bg-accent data-[active=true]:bg-accent/50 data-[active=true]:text-accent-foreground hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground focus-visible:ring-ring/50 [&_svg:not([class*='text-'])]:text-muted-foreground flex flex-col gap-1 rounded-sm p-2 text-sm outline-none focus-visible:ring-[3px] focus-visible:outline-1 [&_svg:not([class*='size-'])]:size-4 transition-colors",
        className
      )}
      {...props}
    />
