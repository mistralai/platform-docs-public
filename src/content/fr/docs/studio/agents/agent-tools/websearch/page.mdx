...
Un autre outil qui utilise les références est l'outil Document Library. Pour plus de détails, consultez le [guide des bibliothèques](/studio/libraries#connecting-libraries-to-agents).
