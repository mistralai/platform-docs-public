...
const REDIRECT_TARGETS: Record<string, string> = {
  ...
  'search-toolkit/document-model': '/studio/search/search-toolkit/concepts/document-model',
  ...
  'search-toolkit/vespa': '/studio/search/search-toolkit/search-index/vespa',
  'search-toolkit/vespa/anatomy': '/studio/search/search-toolkit/search-index/vespa/anatomy',
  'search-toolkit/vespa/cli': '/studio/search/search-toolkit/search-index/vespa/cli',
  'search-toolkit/vespa/local-development': '/studio/search/search-toolkit/search-index/vespa/local-development',
  'search-toolkit/vespa/migration-helpers': '/studio/search/search-toolkit/search-index/vespa/migration-helpers',
  'search-toolkit/vespa/migrations': '/studio/search/search-toolkit/search-index/vespa/migrations',
  'search-toolkit/vespa/operations': '/studio/search/search-toolkit/search-index/vespa/operations',
  'search-toolkit/vespa/query-profiles': '/studio/search/search-toolkit/search-index/vespa/query-profiles',
};
