...
Une fois que vous disposez du fichier de données au bon format,
vous pouvez télécharger le fichier de données vers le client Mistral,
le rendant ainsi disponible pour une utilisation dans les tâches de fine-tuning.
