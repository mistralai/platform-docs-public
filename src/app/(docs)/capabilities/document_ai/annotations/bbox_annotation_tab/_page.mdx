...
Here's an example of how to use our BBox annotation features.
...
The BBox annotation feature lets you extract data and annotate images from the original document. Below is one of the images extracted by our OCR processor.
