...
<SectionTab as="h1" sectionId="prepare-and-upload-your-batch">Prepare and upload your batch</SectionTab>
...
<SectionTab as="h1" sectionId="create-a-new-batch-job">Create a new batch job</SectionTab>
