...
[Ingestion](/studio-api/search-toolkit/ingestion) includes:
...
[Retrieval](/studio-api/search-toolkit/retrieval) includes:
...
- **[Quickstart](/studio-api/search-toolkit/quickstart)**: build your first ingestion and retrieval pipeline end to end.
- **[Document model](/studio-api/search-toolkit/document-model)**: understand `Document`, `DocumentChunk`, and the identity that ties them together.
- **[Search index](/studio-api/search-toolkit/search-index)**: set up your vector store.
- **[Ingestion](/studio-api/search-toolkit/ingestion)**: load, extract, chunk, enrich, and index your documents.
- **[Retrieval](/studio-api/search-toolkit/retrieval)**: configure vector search with optional reranking.
