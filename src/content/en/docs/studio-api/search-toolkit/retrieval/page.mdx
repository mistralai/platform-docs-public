...
- **[Retrievers](/studio-api/search-toolkit/retrieval/retrievers)**: VectorRetriever, KeywordRetriever, and hybrid search patterns
- **[Rerankers](/studio-api/search-toolkit/retrieval/rerankers)**: LLMReRanker, CrossEncoderReRanker, RRF fusion, and custom rerankers
- **[Query preprocessing](/studio-api/search-toolkit/retrieval/preprocessing)**: Query rewriting and expansion for better retrieval quality
- **[Semantic cache](/studio-api/search-toolkit/retrieval/semantic-cache)**: Cache results by query similarity to reduce latency
