...
Le rejeu fiable dépend du caractère déterministe du code du workflow. Voir [Workflows > Déterminisme](/studio/workflows/getting-started/core_concepts/workflows#determinism) pour comprendre la contrainte et comment le SDK l’applique.
