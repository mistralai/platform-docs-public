...
:::warning 
**Deprecated**: `mistral-moderation-2411` is deprecated. Migrate to [`mistral-moderation-2603`](/studio-api/safety-moderation) and update any `moderation_llm_v1` guardrail configs to `moderation_llm_v2`.
:::
