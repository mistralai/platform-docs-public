...
- [Tools](../tools): Make tools accessible to any Agent.
  - [Built-In](../tools/built-in): built-in tools that are available to all agents.
    - [Websearch](../tools/bult-in/websearch): In-depth explanation of our web search built-in connector tool.
    - [Code Interpreter](../tools/bult-in/code_interpreter): In-depth explanation of our code interpreter for code execution built-in connector tool.
    - [Image Generation](../tools/bult-in/image_generation): In-depth explanation of our image generation built-in connector tool.
    - [Document Library (Beta)](../tools/bult-in/document_library): A RAG built-in connector enabling Agents to access a library of documents.
  - [Function Calling](../tools/function_calling): Leverage function calling to create custom tools.
  - [MCP](../tools/mcp): Leverage MCP Servers to create custom tools or use third-party ones.
