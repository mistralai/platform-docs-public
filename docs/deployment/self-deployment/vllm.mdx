...
<Tabs>
    ...
    <TabItem value="vllm-batch-pixtral" label="Image + text input (Pixtral-12B)">
        Suppose you want to caption the following images:
          <center>
              <a href="https://picsum.photos/id/1/512/512"><img alt="" src="/static/img/laptop.png" width="20%"/></a>
              <a href="https://picsum.photos/id/11/512/512"><img alt="" src="/static/img/countryside.png"  width="20%"/></a>
              <a href="https://picsum.photos/id/111/512/512"><img alt="" src="/static/img/vintage_car.png"  width="20%"/></a>
          </center>
...
want to caption the following image:
        ...
        <center>
            <a href="https://picsum.photos/id/237/512/512"><img alt="" src="/static/img/doggo.png"  width="20%"/></a>
        </center>
        <br/>
