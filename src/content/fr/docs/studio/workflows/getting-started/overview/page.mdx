...
Pour plus de détails, voir [Dépôt direct des données volumineuses](/studio/workflows/building-workflows/payload_offloading) et [Chiffrement](/studio/workflows/building-workflows/encryption).
:::
...
|------|------|
| Installer le SDK | [Installation](/studio/workflows/getting-started/installation) |
| Découvrir un workflow opérationnel en 5 minutes | [Votre premier workflow](/studio/workflows/getting-started/your_first_workflow) |
| Comprendre l’architecture des composants | [Concepts clés](/studio/workflows/getting-started/core_concepts) |
| Construire un agent LLM dans un workflow | [Agents résilients](/studio/workflows/building-workflows/durable_agents) |
| Planifier un workflow récurrent | [Planification](/studio/workflows/building-workflows/scheduling) |
