...
Here's an example of how to use our document annotation features.
...
You can also provide a description for each entry. The description is used as detailed information and instructions during the annotation. For example:
...
The document annotation feature lets you extract data and annotate documents. Below is an example of the annotation output:
