...
- [Installation](/mistral-vibe/terminal/install): How to Install Mistral Vibe.
- [Quickstart](/mistral-vibe/terminal/quickstart): A quickstart guide to using Mistral Vibe.
- [Configuration](/mistral-vibe/terminal/configuration): How to Configure Mistral Vibe.
- [Agents & Skills](/mistral-vibe/agents-skills): How to use Agents and Skills with Mistral Vibe.
- [Offline / Local](/mistral-vibe/local): How to run Mistral Vibe with a local model.