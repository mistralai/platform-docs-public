...
For the related concept on the canonical Workflows page, see [Building Workflows > Workflows > Continue-as-new](/studio/workflows/building-workflows/workflows#continue-as-new) and [Core Concepts > Workflows > Determinism](/studio/workflows/getting-started/core_concepts/workflows#determinism).
