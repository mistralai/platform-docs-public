...
Pour comprendre les concepts à l'origine des profils de requête, consultez [Anatomie d'une application Vespa](anatomy).
...
| `ranking.features.query(<weight_name>)` | Poids pour une fonction de classement (voir [Référence du classement](anatomy)) |
...
- **[Gérer le schéma](migrations)** — Système de migration et assistants
