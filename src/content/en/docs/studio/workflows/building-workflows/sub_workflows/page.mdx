...
See [Consuming Streaming Events > Consuming events from workflow trees](/studio/workflows/building-workflows/consuming_events#consuming-events-from-workflow-trees) for the subscription pattern.
