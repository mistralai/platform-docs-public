...
<SectionTab as="h2" variant="secondary" sectionId="general-errors-40">General Errors (40**)</SectionTab>
...
<SectionTab as="h2" variant="secondary" sectionId="activity-errors-41">Activity Errors (41**)</SectionTab>
...
<SectionTab as="h2" variant="secondary" sectionId="workflow-errors-42">Workflow Errors (42**)</SectionTab>
...
<SectionTab as="h2" variant="secondary" sectionId="worker-errors-43">Worker Errors (43**)</SectionTab>
...
<SectionTab as="h2" variant="secondary" sectionId="durable-agent-errors-44">Durable Agent Errors (44**)</SectionTab>

| Code | Description |
|------|-------------|
| `agent_execution_error` | Agent Execution Error |

<SectionTab as="h2" variant="secondary" sectionId="infrastructure-errors-45">Infrastructure Errors (45**)</SectionTab>
...
<SectionTab as="h2" variant="secondary" sectionId="api-endpoint-errors-46">API Endpoint Errors (46**)</SectionTab>
...
<SectionTab as="h2" variant="secondary" sectionId="from-platform-error">`from_platform_error()`</SectionTab>
...
<SectionTab as="h2" variant="secondary" sectionId="from-api-client-error">`from_api_client_error()`</SectionTab>
