...
If the image is hosted online, you can simply provide the **publicly accessible URL of the image** in the request. This method is straightforward and doesn't require any encoding.
