...
LLMs are powerful tools for text generation, and they also show great performance in code generation for multiple tasks, both for code completion, code generation, and agentic tool use for semi-automated software development.
...
Note that we also provide **Codestral Embed**, for semantic search and embedding code databases, repositories, and powering coding assistants with advanced retrieval. Learn more in the [code embeddings documentation](https://docs.mistral.ai/capabilities/embeddings/code_embeddings).
...
If you're interested in using our models in your favorite IDE, you can find below a list of integrations.
...
You can find more information in the [Mistral Vibe documentation](../../mistral-vibe/introduction) or access the [GitHub repository](https://github.com/mistralai/mistral-vibe).
