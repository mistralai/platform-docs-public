...
:::warning
`safe_prompt` is deprecated. We recommend using [Custom Guardrails](/studio/safety-moderation#custom-guardrails) instead, which provides more control over moderation categories and thresholds directly in your API requests.
:::
