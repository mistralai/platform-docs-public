...
| Ministral 3B | | :heavy_check_mark: | A high-performance edge model. Learn more in our [blog post](https://mistral.ai/news/ministraux/) | 128k  | `ministral-3b-2410` | 24.10|
...
| Mistral Embed | | :heavy_check_mark: | Our semantic model for extracting representation of text extracts | 8k  | `mistral-embed` | 23.12|
| Codestral Embed | | :heavy_check_mark: | Our semantic model for extracting representation of code extracts | 8k  | `codestral-embed` | 25.05|
...
Our API endpoints are versioned with specific release dates.
To prevent any disruptions due to model updates and breaking changes,
we recommend using the dated versions of our API.
...
To prepare for model retirements and version upgrades, we recommend that you evaluate your applications with the new models and versions and assess their behavior. We also recommend that you update your applications to use the new models and versions before the retirement date.
