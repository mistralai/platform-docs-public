...
# IBM watsonx.ai
Our Large model is available on the **IBM watsonx.ai** platform as a fully managed solution, as well as an on-premise deployment.
...
You'll need to run your code from a virtual environment with the following packages:
