...
- Timeout if synchronous CPU-bound Python code exceeds 2 seconds ([see more](/workflows/managing-workflows-in-production/rate_limiting))
...
[Learn more about signals](/workflows/interacting-with-workflows/signals)
...
[Learn more about queries](/workflows/interacting-with-workflows/queries)
...
[Learn more about updates](/workflows/interacting-with-workflows/updates)
...
[Learn more about scheduling](/workflows/building-workflows/scheduling)
