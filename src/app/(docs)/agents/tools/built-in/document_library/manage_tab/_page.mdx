...
- [Upload Documents](#upload): Upload documents to a library.
  ...
  - [Get Document](#get-document): Get a document information.
...
At first, a new library will not have any documents inside, it's **empty by default**.
...
You can upload documents to a library freely by proving the library ID and the document file.
