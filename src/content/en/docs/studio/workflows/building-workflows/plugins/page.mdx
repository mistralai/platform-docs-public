...
| [`get_mistral_client`](/studio/workflows/building-workflows/mistral_client) | Dependency: returns a configured `mistralai.Mistral` client with workflow-aware auth, telemetry, and observability metadata |
