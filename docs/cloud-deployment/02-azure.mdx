...
This page contains a summary overview of how to get started with the Mistral Large model deployed
as a pay-as-you-go managed service.
...
- [Azure AI Studio](https://learn.microsoft.com/en-us/azure/ai-studio/how-to/deploy-models-mistral)
