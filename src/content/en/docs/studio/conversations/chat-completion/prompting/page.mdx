...
If you are interested, for more details on how to use structured outputs, you can refer to the [Structured Outputs](/studio/conversations/structured-output) docs.
