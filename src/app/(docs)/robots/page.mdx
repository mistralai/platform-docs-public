...
`MistralAI-Index` is for **automated crawling** of the web for **indexing purposes only**. This is used to **index content** for Mistral AI's search engine, which is used to help answer user questions in Le Chat.
