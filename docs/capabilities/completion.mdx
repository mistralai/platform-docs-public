...
Another covenient flag is the _prefix_ flag, when used in a message it allows the addition of an assistant message at the end of the list, which will be prepended to the assistant's response.
