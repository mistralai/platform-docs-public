...
[Ingestion](/studio/search-toolkit/ingestion) inclut :
...
[Récupération](/studio/search-toolkit/retrieval) inclut :
...
- **[Guide de démarrage](/studio/search-toolkit/quickstart)** : créez votre premier pipeline d’ingestion et de récupération de bout en bout.
- **[Modèle de document](/studio/search-toolkit/document-model)** : comprenez `Document`, `DocumentChunk` et l’identifiant qui les relie.
- **[Index de recherche](/studio/search-toolkit/search-index)** : configurez votre base vectorielle.
- **[Ingestion](/studio/search-toolkit/ingestion)** : chargez, extrayez, découpez en fragments, enrichissez et indexez vos documents.
- **[Récupération](/studio/search-toolkit/retrieval)** : configurez la recherche vectorielle avec reclassement optionnel.
