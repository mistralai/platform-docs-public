...
- We released our first Audio models for chat and a Transcription API:
  ...
  - Voxtral Mini (`voxtral-small-2507`)
...
May 22, 2025
- We released Mistral OCR 2 (`mistral-ocr-2505`) and [annotations](/capabilities/OCR/annotations).
...
January 13, 2025
- We released Codestral 2 (`codestral-2501`).
