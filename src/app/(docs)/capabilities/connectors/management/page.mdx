...
4. **Use** the Connector in [conversations](../conversations) or via [direct tool calls](../tool_calling).
...
List the tools a Connector exposes. This helps verify available tool names before using them in [conversations](../conversations) or [calling them directly](../tool_calling).
