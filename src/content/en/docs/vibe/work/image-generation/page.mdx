...
:::tip
For charts, graphs, and data visualizations, use [Code Interpreter](/vibe/work/code-interpreter) in Work instead. It generates accurate visuals from your actual data using code.
:::
