...
Les clés API fonctionnent en mode gratuit par défaut, avec des limites d'utilisation et de débit adaptées à l'évaluation et au prototypage. Pour augmenter votre utilisation au-delà de l'utilisation mensuelle incluse, activez le **paiement à l'usage** dans <AppLink href="https://admin.mistral.ai/organization/billing" path={["Admin Panel", "Subscriptions", "Billing"]} />.
