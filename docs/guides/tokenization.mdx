...
<img src="/static/img/guides/tokenization1.png" alt="drawing" width="600"/>
...
<img src="/static/img/guides/tokenization3.png" alt="drawing" width="600"/>
...
If you're interested in learning more about how to use Mistral's embedding API, be sure to check out our [embedding guide](/docs/capabilities/embeddings.mdx), which provides detailed instructions and examples.
