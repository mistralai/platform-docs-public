...
| [Deep Research](/vibe/chat-legacy/deep-research): multi-source research with structured, cited reports. | Now only available as a [Skill](/vibe/work/skills) in Work; starting it in Chat redirects to Work. |
