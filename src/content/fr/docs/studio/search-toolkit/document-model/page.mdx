...
- **[Ingestion](/studio/search-toolkit/ingestion)** : comment les documents et les fragments sont produits.
- **[Récupération](/studio/search-toolkit/retrieval)** : comment les fragments sont recherchés et retournés.
- **[Index de recherche](/studio/search-toolkit/search-index)** : comment les fragments sont persistés.
