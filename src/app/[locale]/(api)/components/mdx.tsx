      ...
      <Tag id={id} className={className}>
        ...
        {id && (
          <button
            ...
            aria-label={l.text('Copy link to this heading', { context: 'Accessible label for copying a heading URL' })}
            title={l.text('Copy link', { context: 'Command to copy a heading URL' })}
          >
            <LinkIcon size={16} />
          </button>
        )}
