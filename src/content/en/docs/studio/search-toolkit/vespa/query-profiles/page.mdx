...
<SectionTab as="h2" sectionId="creating-custom-query-profiles">Create custom query profiles</SectionTab>
...
<SectionTab as="h2" sectionId="using-query-profiles-at-query-time">Use query profiles at query time</SectionTab>
