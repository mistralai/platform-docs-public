...
The returned `execution` object contains the `execution_id` and the initial `status` (typically `RUNNING`). You can also trigger executions from [Studio](https://console.mistral.ai/), from [Vibe Work](https://chat.mistral.ai/), or via a schedule.
