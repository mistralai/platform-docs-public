...
The result is a new `version` of the Agent with the new settings. This way, you can keep both the previous and new versions available.

<SectionTab as="h2" variant="secondary" sectionId="create-new-version">Create a new version</SectionTab>

Creates a new `version` of the Agent, which is used by default.
<Tabs groupId="code">
...
Manually change the version of the Agent.
