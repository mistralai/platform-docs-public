...
<figure>
  <Image
    ...
    alt="The expense form rendered in Le Chat, showing typed fields for description, amount, category, date, and receipt ID."
    centered
  />
...
<figure>
  <Image
    ...
    alt="A text field rendered in Le Chat, showing a plain text input."
    centered
  />
...
<figure>
  <Image
    ...
    alt="A number field rendered in Le Chat, showing a numeric input with optional min/max constraints."
    centered
  />
...
<figure>
  <Image
    ...
    alt="A date-time picker rendered in Le Chat."
    centered
  />
...
<figure>
  <Image
    ...
    alt="A date picker rendered in Le Chat."
    centered
  />
...
<figure>
  <Image
    ...
    alt="A confirmation input rendered in Le Chat, showing selectable buttons for each option."
    centered
  />
...
<figure>
  <Image
    ...
    alt="An accept/decline confirmation rendered in Le Chat, showing accept and decline buttons."
    centered
  />
...
<figure>
  <Image
    ...
    alt="A rich UI component rendered in Le Chat, showing a report card with score and badge."
    centered
  />
...
<figure>
  <Image
    ...
    alt="Nested rich UI components in Le Chat, showing cards with line and bar charts side by side."
    centered
  />
...
<figure>
  <Image
    ...
    alt="File tool UI state in Le Chat, showing file create, replace, and delete operations."
    centered
  />
...
<figure>
  <Image
    ...
    alt="Generic tool UI state in Le Chat, showing tool name, arguments, and running/success/failed status."
    centered
  />
...
<figure>
  <Image
    ...
    alt="Command tool UI state in Le Chat, showing a command with running, success, or failed status."
    centered
  />
...
<SectionTab as="h2" variant="secondary" sectionId="tagging-input-variants">Tagging Input Variants</SectionTab>
...
<SectionTab as="h2" variant="secondary" sectionId="structured-content">Structured Content</SectionTab>
