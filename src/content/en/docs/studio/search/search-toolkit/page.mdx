...
[Ingestion](/studio/search-toolkit/ingestion) includes:
...
[Retrieval](/studio/search-toolkit/retrieval) includes:
...
- **[Quickstart](/studio/search-toolkit/quickstart)**: build your first ingestion and retrieval pipeline end to end.
- **[Document model](/studio/search-toolkit/document-model)**: understand `Document`, `DocumentChunk`, and the identity that ties them together.
- **[Search index](/studio/search-toolkit/search-index)**: set up your vector store.
- **[Ingestion](/studio/search-toolkit/ingestion)**: load, extract, chunk, enrich, and index your documents.
- **[Retrieval](/studio/search-toolkit/retrieval)**: configure vector search with optional reranking.
