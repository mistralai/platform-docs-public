...
:::tip
Pour restreindre les clés API autorisées à enregistrer des workflows dans un déploiement, consultez [Déploiements sécurisés](/studio/workflows/managing-workflows-in-production/hardened_deployments).
:::
