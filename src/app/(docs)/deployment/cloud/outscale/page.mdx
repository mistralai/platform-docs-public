...
Our models are available on the Outscale platform as managed deployments.
...
Deployed models expose a REST API that you can query using our SDK or plain HTTP calls.
To run the examples below, you'll need to set the following environment variables:
