...
const STUDIO_DATA = {
    ...
    description: 'Build, test, and deploy AI applications with the Mistral API.',
    quickstarts: [
        {
            title: 'Activate Studio and generate an API key',
            description: 'Activate the free Experiment plan, create a workspace, and generate your first API key.',
            time: '10 min',
            href: '/getting-started/quickstarts/studio/activate-and-generate-api-key',
        },
        {
            title: 'Test a model in the API playground',
            description: 'Send prompts, adjust parameters, and compare model outputs in the Studio playground.',
            time: '5 min',
