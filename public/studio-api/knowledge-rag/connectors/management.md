...
4. **Use** the Connector in [conversations](/studio-api/knowledge-rag/connectors/conversations) or via [direct tool calls](/studio-api/knowledge-rag/connectors/tool_calling).
...
List the tools a Connector exposes. This helps verify available tool names before using them in [conversations](/studio-api/knowledge-rag/connectors/conversations) or [calling them directly](/studio-api/knowledge-rag/connectors/tool_calling).
