...
Vous pouvez empiler autant d'évaluateurs que nécessaire dans une seule exécution. Le SDK calcule automatiquement les statistiques (avg, min, max, std, count) pour chaque évaluateur.
...
from mistralai.evaluations import Evaluation, Evaluator, Mistral, ScorerContext, System, TaskContext
