...
Vous devez également avoir enregistré au moins un [Connecteur](/studio/connectors) pour votre espace de travail. Créez-en un via <a href="https://console.mistral.ai/build/connectors" target="_blank" rel="noopener">Studio &rsaquo; Contexte &rsaquo; Connecteurs</a>, ou via l'[API Connecteurs](/studio/connectors/management).
