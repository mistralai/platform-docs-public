...
- [Forms and confirmations](/studio/workflows/interacting-with-workflows/conversational_workflows/forms_and_confirmations) — structured form inputs and quick confirmation prompts.
- [Progress tracking](/studio/workflows/interacting-with-workflows/conversational_workflows/progress_tracking) — show a checklist of steps with live status updates.
- [Canvas](/studio/workflows/interacting-with-workflows/conversational_workflows/canvas) — return rich content (markdown, code, diagrams) and let the user edit it.
- [Tool UI](/studio/workflows/interacting-with-workflows/conversational_workflows/tool_ui) — render rich UI components and visualize tool execution.
- [Publish in Vibe](/studio/workflows/interacting-with-workflows/conversational_workflows/publish_in_vibe) — surface a workflow as an assistant in Vibe Work.
