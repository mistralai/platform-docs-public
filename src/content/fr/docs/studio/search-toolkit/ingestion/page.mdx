...
- **[Chargeurs de fichiers](/studio/search-toolkit/ingestion/loaders)** : chargement de fichiers depuis un système de fichiers, un stockage cloud ou des sources personnalisées
- **[Extracteurs de documents](/studio/search-toolkit/ingestion/extractors)** : extraction de contenu à partir de PDF, HTML, tableurs, etc.
- **[Sépareurs de texte](/studio/search-toolkit/ingestion/splitters)** : division des documents en fragments avec une taille et un chevauchement optimaux
- **[Enrichisseurs de fragments](/studio/search-toolkit/ingestion/enrichers)** : ajout de métadonnées personnalisées pour le filtrage et le classement
- **[Embedders](/studio/search-toolkit/ingestion/embedders)** : conversion de texte en vecteurs pour la recherche sémantique
- **[Index de recherche](/studio/search-toolkit/search-index)** : stockage et recherche dans les fragments indexés
