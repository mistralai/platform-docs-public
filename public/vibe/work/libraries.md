...
:::info
Unlike [file uploads](/vibe/work/files-and-canvas), which last for a single chat, Libraries persist across sessions. Upload once, use everywhere.
:::
...
<SectionTab as="h2" sectionId="creating-a-library">Creating and populating a Library</SectionTab>
...
<SectionTab as="h3" variant="secondary" sectionId="uploading-documents">Uploading documents</SectionTab>
...
<SectionTab as="h3" variant="secondary" sectionId="adding-web-pages">Adding web pages</SectionTab>
...
<SectionTab as="h2" sectionId="supported-formats">Supported formats</SectionTab>

Libraries accept the same formats as [file uploads](/vibe/work/files-and-canvas):
...
<SectionTab as="h2" sectionId="using-libraries">Using Libraries in tasks</SectionTab>

<SectionTab as="h3" variant="secondary" sectionId="attaching-a-library">Attaching a Library to a chat</SectionTab>
...
<SectionTab as="h3" variant="secondary" sectionId="querying-documents">Querying your documents</SectionTab>
...
<SectionTab as="h3" variant="secondary" sectionId="verifying-sources">Verifying sources</SectionTab>
...
<SectionTab as="h2" sectionId="managing-libraries">Managing Libraries</SectionTab>

<SectionTab as="h3" variant="secondary" sectionId="viewing-documents">Viewing and downloading documents</SectionTab>
...
<SectionTab as="h3" variant="secondary" sectionId="renaming-library">Renaming a Library</SectionTab>

Rename a Library from its settings. The change is visible to all users who have access (they may need to refresh).

<SectionTab as="h3" variant="secondary" sectionId="deleting-library">Deleting a Library</SectionTab>
...
<SectionTab as="h2" sectionId="limits">Limits and processing</SectionTab>
