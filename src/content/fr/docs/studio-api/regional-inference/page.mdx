...
L'inférence régionale achemine vos requêtes API vers des modèles hébergés dans une région géographique spécifique. L'inférence s'effectue dans cette région. Si vous ne spécifiez pas de région, l'API utilise l'endpoint global de Mistral.
