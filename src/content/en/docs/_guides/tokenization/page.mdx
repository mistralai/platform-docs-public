...
If you're interested in learning more about how to use Mistral's embedding API, be sure to check out our [embedding guide](/studio/knowledge-rag/embeddings), which provides detailed instructions and examples.
