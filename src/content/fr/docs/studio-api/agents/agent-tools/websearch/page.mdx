...
Un autre outil qui utilise les références est l'outil Document Library — voir le [guide des bibliothèques](/studio-api/libraries#connecting-libraries-to-agents) pour plus de détails.
