...
:::tip
Avant d’aller plus loin, nous vous recommandons de consulter la documentation [Chat Completions](/studio/conversations/chat-completion) pour en savoir plus sur l’API chat completions et son utilisation.
:::
