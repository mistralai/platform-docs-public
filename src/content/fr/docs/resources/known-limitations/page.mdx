...
Pour la liste complète et à jour, consultez les [fiches modèles](/models).
...
- Le [traitement par batch](/studio/batch-processing) n'est pas comptabilisé dans les limites de taux en temps réel.
