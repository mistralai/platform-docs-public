...
Vibe Work conversation traces are redacted with the default policy before they leave Mistral's infrastructure. In Mistral's hosted service this is managed for you and is not configurable. In a dedicated deployment, the redaction level is set for the whole deployment.
