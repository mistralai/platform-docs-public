...
[AI Studio][platform_url] is our platform where you can access and manage models, usage, APIs, organizations, Workspaces, and a variety of other features.
...
We offer three main solutions:
  ...
  - **Dedicated Serverless**: Dedicated instances tailored to your enterprise needs through a dedicated AI Studio. [Reach out to us](https://mistral.ai/contact) if you're interested!
  - **Self-Hosted**: Dedicated on-premise instances for your enterprise needs through a self-hosted AI Studio. [Reach out to us](https://mistral.ai/contact) if you're interested!
...
|---------------------------|--------------------------------------------|----------------------------------------------------------|---------------------------------------|
| **Infrastructure**        | Owned and managed by Mistral               | Owned and managed by Mistral                             | Owned and managed by client           |
...
- **Third Party Cloud**: You can access our models via your preferred [cloud platforms](/deployment/cloud).
- **Open Weights**: You can self-deploy our models on your own on-premise infrastructure.
    ...
    - **Self-Deploy with Enterprise Support**: You can also self-deploy our models, both open and frontier, with enterprise support. [Reach out to us](https://mistral.ai/contact) if you’re interested!

<SectionTab as="h1" sectionId="api-access-with-ai-studio">API Access with AI Studio - Serverless</SectionTab>

You'll need to activate payments on your account to enable your API keys in [AI Studio][platform_url]. Check out the [Quickstart guide](/getting-started/quickstart/) to get started with your first Mistral API request.
...
For a comprehensive list of options to deploy and use our models on the cloud, head to the **[cloud deployment section](/deployment/cloud)**.

<SectionTab as="h1" sectionId="raw-model-weights">Raw model weights</SectionTab>

Raw model weights can be used in several ways:
- For self-deployment, on cloud or on premise, using either [TensorRT-LLM](/deployment/self-deployment/trt) or [vLLM](/deployment/self-deployment/vllm), head to **[Deployment](/deployment/self-deployment/skypilot)**.
- For research, head to our [reference implementation repository](https://github.com/mistralai/mistral-inference).
