...
- The `guardrails` field allows declaring moderation rules directly in the request, automatically blocking violating content before it reaches the model (see [Custom Guardrails](../guardrailing#custom-guardrails)).
