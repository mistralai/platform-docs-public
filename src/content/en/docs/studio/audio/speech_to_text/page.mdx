...
- **[Offline Transcription](/studio/audio/speech_to_text/offline_transcription)**: Learn how to use Voxtral Mini Transcribe V2 for batch transcription, including speaker diarization, context biasing, and word-level timestamps.
- **[Realtime Transcription](/studio/audio/speech_to_text/realtime_transcription)**: Learn how to integrate Voxtral Realtime for live transcription with ultra-low latency, perfect for voice agents and real-time applications.

:::info
Looking for translating more than one file at a time? Check our [Batch feature](/studio/batch-processing) (via API)
:::
