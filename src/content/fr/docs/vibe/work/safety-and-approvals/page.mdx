...
- *"Quel Projet dois-je consulter : le lancement du T3 ou la planification du T4 ?"*
- *« Le brief doit-il faire une page ou un rapport complet ? »*
- *"Quel Connecteur dois-je utiliser pour trouver le contrat : Notion ou Google Drive ?"*
...
Pour les tâches longues ou multi-étapes, Work affiche sa **liste de tâches** dans le **panneau latéral droit** au fur et à mesure, une checklist en direct des étapes qu'il a terminées ou qu'il s'apprête à effectuer. Aucun plan préalable à valider : Work commence immédiatement, et vous voyez les étapes s'afficher et se terminer en temps réel.
...
<SectionTab as="h2" sectionId="reasoning">Voir le résumé du raisonnement de Work en temps réel</SectionTab>

Pendant l'exécution, Work affiche un **résumé du raisonnement** pour chaque étape. Vous voyez ce que Work lit, compare, choisit ou écarte.
...
- Les **Connecteurs** de connaissances (Google Drive, SharePoint) sont disponibles sur les plans Team et Enterprise et nécessitent une configuration Admin avant que tout utilisateur puisse les Connecter.
