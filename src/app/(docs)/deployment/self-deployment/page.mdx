...
Our models can be **self-deployed on your own infrastructure** through various
inference engines. We recommend using [vLLM](https://vllm.readthedocs.io/), a
highly optimized Python-only serving framework that can expose an OpenAI-compatible
API.
...
You can also use specific tools to facilitate infrastructure management, such as
