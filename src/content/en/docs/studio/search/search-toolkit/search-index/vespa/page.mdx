...
<SectionTab as="h2" sectionId="using-vespa-as-a-search-backend">Use Vespa as a search backend</SectionTab>

To use Vespa as a search backend in your Search Toolkit pipelines, see [Search index](/studio/search/search-toolkit/search-index).
