...
Regional inference routes your API requests to models hosted in a specific geographic region. Inference occurs within that region. If you don't specify a region, the API uses the global Mistral endpoint.
...
<SectionTab as="h3" variant="secondary" sectionId="python-sdk-version">SDK version ≥ 2.70</SectionTab>
