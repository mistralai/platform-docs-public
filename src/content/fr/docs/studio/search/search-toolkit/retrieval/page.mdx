...
- **[Récupérateurs](/studio/search/search-toolkit/retrieval/retrievers)** : VectorRetriever, KeywordRetriever et modèles de recherche hybrides
- **[Reclasseurs](/studio/search/search-toolkit/retrieval/rerankers)** : LLMReRanker, CrossEncoderReRanker, fusion RRF et reclasseurs personnalisés
- **[Prétraitement des requêtes](/studio/search/search-toolkit/retrieval/preprocessing)** : Réécriture et expansion des requêtes pour une meilleure qualité de recherche
- **[Cache sémantique](/studio/search/search-toolkit/retrieval/semantic-cache)** : Mise en cache des résultats par similarité de requête pour réduire la latence
