...
**Realtime**:
We provide a live transcription functionality. You can find more info about Realtime [here](/studio/audio/speech_to_text/realtime_transcription).
...
<SectionTab as="h2" variant="secondary" sectionId="example-samples-2">Example Samples</SectionTab>

Below you can find a few examples using the audio transcription endpoint.
...
| Feature                                             | OpenAI SDK compatible     |
| :-------------------------------------------------- | :------------------------ |
| Basic transcription (`file`)                        | Yes                       |
| Language specification (`language`)                 | Yes                       |
| Timestamp granularities (`timestamp_granularities`) | Yes                       |
| Streaming (`stream`)                                | Yes                       |
| Diarization (`diarize`)                             | Yes with `extra_body`     |
| Context biasing (`context_bias`)                    | Yes with `extra_body`     |
| Audio URL input (`file_url`)                        | No (not supported)        |
