...
- [Embeddings de texte](embeddings/text_embeddings) : intégrez une large variété de texte avec un modèle d’embedding polyvalent.
- [Embeddings de code](embeddings/code_embeddings) : intégrez des bases de données de code et des dépôts pour la récupération de code.
