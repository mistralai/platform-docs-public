...
Save audio samples as reusable voices. Once created, a voice can be referenced by `voice_id` in any [speech generation](/studio/audio/text_to_speech/speech) request, avoiding the need to pass `ref_audio` each time.
