...
:::note
For multi-source, in-depth research with structured cited reports and PDF export, use [Deep Research](/vibe/chat-legacy/deep-research), now available as a Skill in Work.
:::
...
| Get a structured, cited report pulling from many sources | **[Deep Research](/vibe/chat-legacy/deep-research)** Skill in Work |
