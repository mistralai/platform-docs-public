...
**« Compte tenu du taux d'intérêt de la Banque centrale européenne en janvier 2025, trace un graphique du taux d'intérêt composé sur les 10 prochaines années »**

Le second exemple demande le taux d'intérêt de la Banque centrale européenne et de tracer un graphique de l'intérêt composé. Nous avons maintenant besoin d'un appel de fonction local puisque `ecb-interest-rate-agent` sera certainement requis.
...
<SectionTab as="h2" variant="secondary" sectionId="output-events">Événements de sortie</SectionTab>

Vous pouvez voir ci-dessous les événements de sortie de la conversation dans l'ordre d'apparition pour l'exemple ci-dessus.
