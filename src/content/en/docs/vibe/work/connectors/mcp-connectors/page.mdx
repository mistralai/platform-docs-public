...
<SectionTab as="h3" variant="secondary" sectionId="become-an-official-marketplace-connector">Become an official Marketplace connector</SectionTab>

Building a connector for others to use? Providers can apply to become an official Marketplace connector. See the [submission process](/studio/connectors#become-an-official-marketplace-connector) to get your connector featured.
