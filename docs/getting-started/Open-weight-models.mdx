...
| Codestral-22B-v0.1  | [raw_weights](https://models.mistralcdn.com/codestral-22b-v0-1/codestral-22B-v0.1.tar) <br/> [Hugging Face](https://huggingface.co/mistralai/Codestral-22B-v0.1) | - 32768 vocabulary size <br/> - Supports v3 Tokenizer |
