...
- **[File loaders](/studio/search-toolkit/ingestion/loaders)**: load files from filesystem, cloud storage, or custom sources
- **[Document extractors](/studio/search-toolkit/ingestion/extractors)**: extract content from PDFs, HTML, spreadsheets, and more
- **[Text splitters](/studio/search-toolkit/ingestion/splitters)**: divide documents into chunks with the size and overlap you choose
- **[Chunk enrichers](/studio/search-toolkit/ingestion/enrichers)**: add custom metadata for filtering and ranking
- **[Embedders](/studio/search-toolkit/ingestion/embedders)**: convert text to vectors for semantic search
- **[Search index](/studio/search-toolkit/search-index)**: store and search over indexed chunks
