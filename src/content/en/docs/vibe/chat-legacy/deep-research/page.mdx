...
:::warning
Deep Research is a legacy Chat feature. The Chat tab is being removed progressively — Enterprise organizations may still have access during the six-month migration window.

If you no longer have access, use the equivalent: the [Deep Research Skill](/vibe/work/skills) in Work, where it works with [Connectors](/vibe/work/connectors) and [Canvas](/vibe/work/files-and-canvas).
:::
