...
```python
# Ajouter un enregistrement avec des messages et des propriétés
...
```python
# Importer depuis un fichier JSONL
# Commencez par télécharger le fichier pour obtenir un file_id :
...
# Importer depuis les résultats de recherche Explorer
...
```python
# Lister les enregistrements d’un Dataset
