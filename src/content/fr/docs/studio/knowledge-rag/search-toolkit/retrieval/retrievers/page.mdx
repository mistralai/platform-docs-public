---
title: Récupérateurs
description: Recherchez dans votre index à l'aide de stratégies vectorielles, par mots-clés ou hybrides.
sidebar_position: 2
...
- [Reclassements](rerankers) — Réévaluer les résultats pour un meilleur classement
