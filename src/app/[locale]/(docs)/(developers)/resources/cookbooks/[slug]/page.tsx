...
export async function generateMetadata({
  ...
  if (!entry) {
    return {
      title: l.text('Cookbook Not Found', { context: 'Not found message for a developer cookbook' }),
      description: l.text('The requested cookbook could not be found.', { context: 'Meta description for a missing developer cookbook' }),
    };
  }

  const title = l.text('{cookbookTitle} - Mistral AI Cookbook', { values: { cookbookTitle: entry.title }, context: 'Page title for a developer cookbook' });
  const description = l.text("Learn {cookbookTitle} with practical examples and code snippets using Mistral AI's LLMs.", { values: { cookbookTitle: entry.title }, context: 'Meta description for a developer cookbook' });
