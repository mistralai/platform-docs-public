...
Open <AppLink href="https://admin.mistral.ai/organization/members" path={["Admin Console", "Administration", "Members"]} />.
...
:::note
If a profile is externally managed, name and email are synced from your identity provider and cannot be edited in the Admin Console.
:::
...
When SAML SSO is enabled, Organization admins can turn on **automatic seat assignment** from <AppLink href="https://admin.mistral.ai/organization/access" path={["Admin Console", "Administration", "Access"]} />.
