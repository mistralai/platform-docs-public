...
For more information regarding OCR, visit the [Document AI - OCR](/studio/document-processing/basic_ocr) docs and the corresponding [API Spec](../api/endpoint/ocr#operation-ocr_v1_ocr_post).