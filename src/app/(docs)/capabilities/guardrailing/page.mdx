...
- `mistral-moderation-2411` is an 8B model based on [Ministral 8B 24.10](/models/ministral-8b-24-1)
- `mistral-moderation-2603` is a 3B model based on [Ministral 3B 25.12](/models/ministral-3-3b-25-12)
...
<ExplorerTabs id="categories">
  <ExplorerTab value="mistral-moderation-2603" label="mistral-moderation-2603">
...
:::
  ...
  <ExplorerTab value="mistral-moderation-2411" label="mistral-moderation-2411">
...
:::note[ ]
`Dangerous and Criminal Content` is a legacy category only available in `mistral-moderation-2411`. It has been replaced by the separate `Dangerous` and `Criminal` categories in `mistral-moderation-2603`.
:::
