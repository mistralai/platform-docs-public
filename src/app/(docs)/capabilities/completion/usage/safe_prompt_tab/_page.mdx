...
The `safe_prompt` flag is a boolean that introduces a first level of moderation to **make replies safer and more respectful**. We recommend taking a look at our [moderation](./guardrailing) docs for better moderation.
<Tabs>
