...
- [Agents & Conversations](/studio/agents/agents-api): Basic explanations and code snippets around our Agents and Conversations API.
- [Tools](/studio/agents/agent-tools): Make tools accessible to any Agent.
  - [Websearch](/studio/agents/agent-tools/websearch): In-depth explanation of our web search built-in connector tool.
  - [Code Interpreter](/studio/agents/agent-tools/code_interpreter): In-depth explanation of our code interpreter for code execution built-in connector tool.
  - [Image Generation](/studio/agents/agent-tools/image_generation): In-depth explanation of our image generation built-in connector tool.
  - [Document Library](/studio/search/libraries#connecting-libraries-to-agents): A RAG built-in tool enabling Agents to search through your [Libraries](/studio/search/libraries).
  - [Function Calling](/studio/agents/agent-tools/function-calling): Use function calling to create custom tools.
  - [Connectors](/studio/connectors): Register MCP servers as managed Connectors and use them as tools in conversations and Agents.
- [Handoffs](/studio/agents/handoffs): Relay tasks and use other agents as tools in agentic workflows.
