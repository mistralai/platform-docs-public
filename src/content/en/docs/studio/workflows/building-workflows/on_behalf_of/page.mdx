...
:::warning
On-behalf-of workflows require a [hardened deployment](/studio/workflows/managing-workflows-in-production/hardened_deployments). They cannot be registered in a non-hardened deployment.
:::
...
:::note
`get_mistral_client()` provides more than OBO support — it also handles telemetry and observability metadata. See [Mistral client](/studio/workflows/building-workflows/mistral_client) for the full list of features.
:::
