...
Here is an example of how to achieve this using our client and Pydantic/Zod/JSON Schemas:
...
:::note
To better guide the model, the following is always prepended to the system prompt when using this method:
