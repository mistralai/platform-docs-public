        ...
        <div className="relative api-desktop:flex flex-col items-center justify-center hidden">
          ...
          <div className="not-prose z-10 mt-14 text-secondary-foreground opacity-70 flex flex-col items-center justify-center gap-4">
            <div className="flex flex-col items-center gap-1">
              <h3 className="text-2xl font-bold">{l.text('Examples', { context: 'Heading for code examples' })}</h3>
              <p className="text-sm">
                {l.rich('Real world code <b>examples</b>', {
                  context: 'Description of real-world code examples',
                  tags: { b: (c) => <span className="font-bold">{c}</span> },
                })}
              </p>
            </div>
