---
title: Group tasks with Projects
sidebar_position: 11
---
...
<SectionTab as="h2" sectionId="creating-a-project">Creating a Project</SectionTab>
...
<SectionTab as="h2" sectionId="project-instructions">Project instructions and context</SectionTab>
...
- **Tone**: pick a tone for this Project, or keep `Default (Global)` to inherit the tone from your account-level [Custom instructions](/vibe/work/custom-instructions).
...
<SectionTab as="h2" sectionId="managing-chats">Managing chats</SectionTab>

The Project overview page shows all your chats in list or grid view. From there you can add, move, or remove chats.

<SectionTab as="h3" variant="secondary" sectionId="adding-a-chat">Adding a chat</SectionTab>
...
<SectionTab as="h3" variant="secondary" sectionId="moving-a-chat">Moving a chat to another Project</SectionTab>

Open the chat, click the folder icon, and select a different Project. The chat moves there automatically.

<SectionTab as="h3" variant="secondary" sectionId="removing-a-chat">Removing a chat</SectionTab>
...
<SectionTab as="h2" sectionId="deleting-a-project">Deleting a Project</SectionTab>
