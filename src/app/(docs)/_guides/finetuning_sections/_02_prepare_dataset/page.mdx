...
<details>
    ...
    for the labels. In this case, we can use the flagship model Mistral Large to
...
<details>
    ...
    In fact, our function calling capabilities are achieved through fine-tuning on
