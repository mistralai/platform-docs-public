...
Voir [Créer des workflows > Activités > Bases](/studio/workflows/building-workflows/activities/basics) pour toutes les options de configuration.
...
**Limite de 2 Mo en entrée/sortie.** Chaque activité est limitée à 2 Mo maximum en entrée et en sortie. Pour l’envoi de payloads plus volumineux, voir [Externalisation des charges utiles](/studio/workflows/building-workflows/payload_offloading).
