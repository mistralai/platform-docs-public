...
Pour plus d'informations concernant l'OCR, consultez la documentation [Document AI - OCR](/studio/document-processing/basic_ocr) et la [spécification API](../api/endpoint/ocr#operation-ocr_v1_ocr_post) correspondante.
