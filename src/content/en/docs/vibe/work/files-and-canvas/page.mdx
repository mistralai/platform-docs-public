...
:::note
For heavier document processing needs (structured extraction from scanned PDFs, multi-page forms, or handwritten content in bulk), check Studio's [Document AI](/studio/document-processing/overview) features.
:::
...
:::note
For data analysis (custom statistics, charts, transformations), use [Code Interpreter](/vibe/work/code-interpreter) in Work — a native sandbox available on paid plans.
:::
