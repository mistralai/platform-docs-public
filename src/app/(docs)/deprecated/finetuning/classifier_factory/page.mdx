...
By using classification models, organizations can make data-driven decisions, improve operational efficiency, and deliver better products and services to their customers.

For this reason, we designed a friendly and easy way to make your own classifiers. Using our small but highly efficient models and training methods, the Classifier Factory is available directly in the [AI Studio](https://console.mistral.ai/build/finetuned-models) and our API.
...
Explore our guides and [cookbooks](https://github.com/mistralai/cookbook) using the Classifier Factory:
