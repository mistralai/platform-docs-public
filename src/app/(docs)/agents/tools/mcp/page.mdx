...
The Model Context Protocol (MCP) is an open standard designed to **simplify the integration of AI models with various data sources and tools**. By providing a **standardized interface**, MCP enables secure connections, allowing AI systems to access and use contextual information efficiently. It simplifies the development process, making it easier to build robust and interconnected AI applications.
...
Our Python SDK enables easy integration of our agents with MCP clients.
...
<ExplorerTabs id="mcp-setup" groupId="code">
...
Here's a brief example of how to stream conversations:
