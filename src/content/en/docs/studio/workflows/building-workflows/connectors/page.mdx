...
You also need at least one [Connector](/studio/connectors) registered for your Workspace. Create one from <AppLink href="https://console.mistral.ai/build/connectors" app="studio" path={["Context", "Connectors"]} />, or with the [Connectors API](/studio/connectors/management).
