...
Reliable replay depends on workflow code being deterministic. See [Workflows > Determinism](/studio/workflows/getting-started/core_concepts/workflows#determinism) for the constraint and how the SDK enforces it.
