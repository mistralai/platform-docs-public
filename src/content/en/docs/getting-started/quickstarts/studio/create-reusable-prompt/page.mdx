...
sidebar_position: 3
description: Save a prompt template in Studio and reuse it across your workspace in ~5 minutes.
---
...
Use <AppLink href="https://console.mistral.ai/build/prompts" app="studio">Prompts</AppLink> to save prompt templates your team can reuse in Studio and in applications that reference shared prompt definitions.
...
<SectionTab as="h2" sectionId="step-5">Step 5: Create a new version</SectionTab>
