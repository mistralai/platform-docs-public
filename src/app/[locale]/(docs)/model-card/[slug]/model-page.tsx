            ...
            <ModelCard className="relative flex flex-col gap-6 p-5">
              ...
              <div className="flex items-baseline justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {model.tags?.includes('third-party') && (
                    <Badge variant="outline" size="xs" className="font-mono uppercase text-[11px]">
                      {l.text('Third-party', { context: 'Badge for a third-party externally developed AI model hosted by Mistral' })}
                    </Badge>
                  )}
                  {model.type && (
                    <ModelTypeBadge
                  ...
                  {showRatings && speed && performance && (
                    <>
                      ...
                      <SectionBlock>
                        ...
                        <StatRating
                          maxStars={model.performanceMaxStars ?? 4}
                          isLegacy={isLegacy}
                          rating={performance}
                        />
                      </SectionBlock>
                  ...
                  <ModelCardInner className="ml-auto border-l border-dashed pb-3 pt-3 px-4">
                    <div className="ml-auto items-start flex flex-col gap-2 justify-center">
                      ...
                      <Price
                        ...
                        locale={locale}
                        layout={model.pricingLayout ?? 'default'}
                      />
                    </div>
                  </ModelCardInner>
                )}
...
const getCompareUrl = (models: string[]) => {
  ...
  return `/inference/model-selection-guide?${searchParams.toString()}`;
};
