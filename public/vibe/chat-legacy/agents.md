...
Agents created in Chat are designed for the chat interface and can't be used programmatically. If you need API access, create Agents through <AppLink href="https://console.mistral.ai/build/agents" app="studio">Agents</AppLink> or the [REST API](https://docs.mistral.ai/api/#tag/beta.agents).
