...
In Studio, each run has its `System` recorded. You can compare score distributions across temperatures at a glance. See [System params](/studio/observability/evaluations/system-params) for details.
