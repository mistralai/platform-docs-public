...
You can also upload a PDF file to our cloud and get the OCR results from the uploaded PDF by retrieving a signed URL.
...
For OCR tasks, you can get a signed URL to access the file. An optional `expiry` parameter lets you automatically expire the signed URL after n hours.
...
Once all OCR is done, you can optionally delete the PDF file from our cloud unless you wish to reuse it later.
