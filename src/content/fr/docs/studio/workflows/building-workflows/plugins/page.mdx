...
| [`get_mistral_client`](/studio/workflows/building-workflows/mistral_client) | Dépendance : renvoie un client `mistralai.Mistral` configuré avec une authentification adaptée aux workflows, ainsi que des métadonnées de télémétrie et d’observabilité |
