...
Vous pouvez aussi enregistrer des serveurs MCP comme [Connecteurs](/studio-api/connectors) pour utiliser des outils externes dans les conversations et Agents.
