...
npm and PyPI were compromised by a supply chain attack related to the **TanStack security incident**. An automated worm associated with the attack led to **compromised package versions being published on both npm and PyPI**.
