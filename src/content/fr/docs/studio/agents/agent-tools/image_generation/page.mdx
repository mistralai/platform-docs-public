...
La génération d'images est un [outil](/studio/agents/agent-tools#built-in-tools) intégré qui permet aux agents de générer des images de toutes sortes et sous toutes les formes.
