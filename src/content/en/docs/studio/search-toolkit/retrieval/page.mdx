...
- **[Retrievers](/studio/search-toolkit/retrieval/retrievers)**: VectorRetriever, KeywordRetriever, and hybrid search patterns
- **[Rerankers](/studio/search-toolkit/retrieval/rerankers)**: LLMReRanker, CrossEncoderReRanker, RRF fusion, and custom rerankers
- **[Query preprocessing](/studio/search-toolkit/retrieval/preprocessing)**: Query rewriting and expansion for better retrieval quality
- **[Semantic cache](/studio/search-toolkit/retrieval/semantic-cache)**: Cache results by query similarity to reduce latency
