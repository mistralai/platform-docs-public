...
When creating an agent, you'll receive an Agent object with an agent ID. You can then use that ID to have conversations.
...
For more information, see our [web search tool documentation](/agents/tools/built-in/websearch).