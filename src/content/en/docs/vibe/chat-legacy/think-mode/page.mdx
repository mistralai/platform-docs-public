...
:::warning
Think mode is a legacy Chat feature. The Chat tab is being removed progressively — Enterprise organizations may still have access during the six-month migration window.

If you no longer have access, use the equivalent: the **fast/think toggle** in the unified experience switches between quick conversational responses and extended reasoning. See [Get started with Work](/vibe/work/get-started).
:::
...
- **[Deep Research](/vibe/chat-legacy/deep-research)**: for questions that need multi-source web research and a structured report. Now available as a [Skill](/vibe/work/skills) in Work.
