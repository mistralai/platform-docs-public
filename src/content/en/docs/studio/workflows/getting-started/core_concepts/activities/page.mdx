...
See [Building Workflows > Activities > Basics](/studio/workflows/building-workflows/activities/basics) for full configuration options.
...
**2MB input/output limit.** Each activity call is limited to 2MB in and 2MB out. See [Payload offloading](/studio/workflows/building-workflows/payload_offloading) for larger payloads.
