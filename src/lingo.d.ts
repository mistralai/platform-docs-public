...
declare module "@lingo.dev/react" {
  interface LingoMessages {
    ...
    "A list of all available models, helping you explore their capabilities, performance, trade-offs, and more.": { context: "Introductory description of the AI model catalog" };
    ...
    "Audio models": { context: "Heading for audio model family" };
    "Code models": { context: "Heading for code model family" };
    "Embedding models": { context: "Heading for embedding model family" };
    "Moderation and safety models": { context: "Heading for moderation and safety model family" };
    "Other specialist models": { context: "Heading for other specialist model family" };
    "Text and multimodal models for broad reasoning, coding, tool use, and agentic tasks.": { context: "Description for generalist AI model group" };
    "Models for document understanding, text extraction, and structured OCR outputs.": { context: "Description for OCR model group" };
    "Models for speech transcription, realtime transcription, and speech generation.": { context: "Description for audio model group" };
    "Specialized models for code generation, completion, and software engineering agents.": { context: "Description for code model group" };
    "Models that turn text or code into vectors for retrieval and similarity search.": { context: "Description for embedding model group" };
    ...
    "Specialized models": { context: "Heading for specialized model pricing table" };
    "Models built for specific tasks such as code, vision, OCR, and audio.": { context: "Description for specialized model pricing table" };
    "Models built for specific tasks such as vision, OCR, and audio.": { context: "Description for specialized model pricing table" };
    "Third-party hosted": { context: "Heading for third-party hosted model pricing table" };
    "Third-party models hosted by Mistral.": { context: "Description for third-party hosted model pricing table" };
    "Experiments": { context: "Heading for experimental model pricing table" };
    "Research previews and experimental releases.": { context: "Description for experimental model pricing table" };
    "Standard": { context: "Standard pricing mode label" };
    "Priority": { context: "Priority pricing mode label" };
    "Pricing mode": { context: "Accessible label for pricing mode selector" };
    "Prices": { context: "Pricing table unit prefix" };
    "Prices as marked": { context: "Pricing table unit prefix when prices have different units" };
    "Free": { context: "Free price label" };
    ...
    "API": { context: "Glossary category label" | "Keyword tag for the Agents API feature" | "Table heading for the AI model API identifier" | "Top navigation label for the API reference" | "Title of the Inference landing card linking to the API reference" | "Title of the Resources landing card linking to the API reference" };
    ...
    "Public Preview": { context: "Heading for Public Preview API endpoints" | "Lifecycle stage label for an AI model available in public preview" | "Lifecycle status label for a public preview inference feature" };
    ...
    "Changelogs": { context: "Title of a documentation card about Changelogs" | "Title of the Resources landing card linking to changelogs" };
    ...
    "Cookbooks": { context: "Footer link to developer cookbooks" | "Title of a documentation card about Cookbooks" | "Title of the Resources landing card linking to cookbooks" };
    ...
    "Third-party": { context: "Badge for a third-party externally developed AI model hosted by Mistral" };
    ...
    "GA": { context: "Lifecycle stage label for a generally available AI model (GA = Generally Available)" | "Lifecycle status label for a generally available inference feature" };
    ...
    "Labs": { context: "Badge for an experimental AI model" | "Heading for Labs model pricing table" | "Title of the Inference landing card linking to Labs" };
    ...
    "Models": { context: "Glossary category label" | "Label for AI models" | "Top navigation label for AI models" | "Title of the Inference landing card linking to the model catalog" };
    ...
    "SDKs": { context: "Title of a documentation card about SDKs" | "Title of the Resources landing card linking to SDKs" };
    ...
    "View all models with specifications, benchmarks, and feature comparison.": { context: "Description of the navigation card to the full AI model catalog" | "Description of the Inference landing card linking to the model catalog" };
    ...
    "Compare model pricing by family.": { context: "Description of the Inference landing card linking to model pricing" };
    "Model lifecycle policy": { context: "Title of the Inference landing card linking to the model lifecycle policy" };
    "Plan for model maturity stages, aliases, deprecations, and retirement.": { context: "Description of the Inference landing card linking to the model lifecycle policy" };
    "Route inference requests to a specific region.": { context: "Description of the Inference landing card linking to regional inference" };
    "Priority tier": { context: "Title of the Inference landing card linking to Priority tier" };
    "Route eligible API requests through a priority queue.": { context: "Description of the Inference landing card linking to Priority tier" };
    "Explore experimental model releases.": { context: "Description of the Inference landing card linking to Labs" };
    "Prompting": { context: "Title of the Inference landing card linking to prompting guidance" };
    "Design prompts for model requests.": { context: "Description of the Inference landing card linking to prompting guidance" };
    "Sampling": { context: "Title of the Inference landing card linking to sampling guidance" };
    "Tune generation parameters.": { context: "Description of the Inference landing card linking to sampling guidance" };
    "Review endpoint details.": { context: "Description of the Inference landing card linking to the API reference" };
    "Mistral inference is the serving layer for running models through the API. Use it to choose the right model, send low-latency requests, route traffic by region, and control generation behavior with prompting and sampling parameters.": { context: "Introductory description for the Inference landing page" };
    "Find reference material for model choice, pricing, lifecycle, regional routing, and request behavior.": { context: "Intro text for Inference landing page cards" };
    "Explore endpoints, authentication, schemas, and errors.": { context: "Description of the Resources landing card linking to the API reference" };
    "Install official SDKs for Python, TypeScript, and other languages.": { context: "Description of the Resources landing card linking to SDKs" };
    "Security advisories": { context: "Title of the Resources landing card linking to security advisories" };
    "Review security advisories and remediation guidance.": { context: "Description of the Resources landing card linking to security advisories" };
    "Release notes": { context: "Title of the Resources landing card linking to release notes" };
    "Follow shipped updates across Vibe, Studio, Admin, models, and the API.": { context: "Description of the Resources landing card linking to release notes" };
    "Track API updates, model releases, deprecations, and breaking changes.": { context: "Description of the Resources landing card linking to changelogs" };
    "Build with step-by-step examples for RAG, function calling, evaluation, and more.": { context: "Description of the Resources landing card linking to cookbooks" };
    "Find community programs, examples, and contribution paths.": { context: "Description of the Resources landing card linking to the ambassador program" };
    "Mistral Events ↗": { context: "Title of the Resources landing card linking to Mistral events" };
    "Join Mistral events, meetups, and community sessions.": { context: "Description of the Resources landing card linking to Mistral events" };
    "Glossary": { context: "Title of the Resources landing card linking to the glossary" };
    "Look up platform, model, API, and billing terms.": { context: "Description of the Resources landing card linking to the glossary" };
    "Error glossary": { context: "Title of the Resources landing card linking to the error glossary" };
    "Map HTTP errors to causes and fixes.": { context: "Description of the Resources landing card linking to the error glossary" };
    "Known limitations": { context: "Title of the Resources landing card linking to known limitations" };
    "Review current platform, model, and API constraints.": { context: "Description of the Resources landing card linking to known limitations" };
    "Migration guides": { context: "Title of the Resources landing card linking to migration guides" };
    "Switch from another provider to the Mistral API with minimal code changes.": { context: "Description of the Resources landing card linking to migration guides" };
    "Observability integrations": { context: "Title of the Resources landing card linking to observability integrations" };
    "Connect Mistral traces and evaluations to third-party tools.": { context: "Description of the Resources landing card linking to observability integrations" };
    "Resources bring together the references, examples, and support material that help you build with Mistral. Start here when you need an SDK, a cookbook, a glossary definition, release notes, migration guidance, or a support reference.": { context: "Introductory description for the Resources landing page" };
