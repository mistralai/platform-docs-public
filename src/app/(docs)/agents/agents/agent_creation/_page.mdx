...
- `guardrails` *optional*: A list of guardrail configurations applied to all conversations using this agent. See [Custom Guardrails](../../capabilities/guardrailing#custom-guardrails) for details.
