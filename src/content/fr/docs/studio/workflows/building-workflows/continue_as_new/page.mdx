...
Pour le concept associé sur la page Workflows de référence, voir [Créer des workflows > Workflows > Continue-as-new](/studio/workflows/building-workflows/workflows#continue-as-new) et [Principes de base > Workflows > Déterminisme](/studio/workflows/getting-started/core_concepts/workflows#determinism).
