...
- [Formulaires et confirmations](/studio/workflows/interacting-with-workflows/conversational_workflows/forms_and_confirmations) : saisies structurées et confirmations rapides.
- [Suivi de progression](/studio/workflows/interacting-with-workflows/conversational_workflows/progress_tracking) : afficher une checklist des étapes avec des mises à jour en temps réel.
- [Canvas](/studio/workflows/interacting-with-workflows/conversational_workflows/canvas) : retourner du contenu enrichi (markdown, code, schémas) et permettre à l'utilisateur de l'éditer.
- [UI d'outil](/studio/workflows/interacting-with-workflows/conversational_workflows/tool_ui) : afficher des composants et visualiser l'exécution de l'outil.
- [Publier dans Vibe](/studio/workflows/interacting-with-workflows/conversational_workflows/publish_in_vibe) : proposer un workflow comme assistant dans Vibe Work.
