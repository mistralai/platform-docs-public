...
- **Zero data retention**: review whether troubleshooting and analytics data are stored for your Organization. When zero data retention is enabled, troubleshooting and analytics data are not stored. See [Zero data retention](/admin/monitor-comply/zero-data-retention) for supported endpoints, exclusions, and request steps.
