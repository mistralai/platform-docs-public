...
:::warning
Agents are a legacy Chat feature. The Chat tab is being removed progressively — Enterprise organizations may still have access during the six-month migration window.

If you no longer have access, use [Skills](/vibe/work/skills) instead: reusable instructions, tools, and knowledge sources that you configure once and reuse across tasks.
:::
