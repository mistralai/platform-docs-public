...
:::tip
Avant de continuer, nous vous recommandons de lire la documentation [Chat Completions](/studio/conversations/chat-completion) pour en savoir plus sur l'API chat completions et comment l'utiliser avant de poursuivre.
:::
...
| [Mistral Medium 3.5](/models/mistral-medium-3-5-26-04)<br/>- `mistral-medium-latest` | [Devstral Small 2](/models/devstral-small-2-25-12)<br/>- `devstral-small-latest` |[Magistral Small 1.2](/models/magistral-small-1-2-25-09)<br/>- `magistral-small-latest`        |
...
| [Ministral 3 14B](/models/ministral-3-14b-25-12)<br/>- `ministral-14b-latest`   |        |     |
| [Ministral 3 8B](/models/ministral-3-8b-25-12)<br/>- `ministral-8b-latest` |       |     |
| [Ministral 3 3B](/models/ministral-3-3b-25-12)<br/>- `ministral-3b-latest` |       |     |

Pour des informations exhaustives sur tous nos modèles, consultez la [page Modèles](/models).
...
Si vous vous intéressez aux appels de fonction et souhaitez explorer les solutions intégrées, MCP et d'autres cas d'usage agentiques, nous vous invitons à consulter la documentation Agents [ici](/studio/agents/introduction).
