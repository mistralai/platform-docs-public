    ...
    <div className="not-prose">
      <div className="flex items-center gap-6 font-mono mb-4 w-full">
        <div className="flex items-center gap-3 flex-1">
          <p className="text-xs lg:text-sm text-foreground shrink-0 tracking-wide uppercase font-medium font-mono">
            [{readingTime.text}]
          </p>
            ...
            {githubUrl && (
              ...
              >
                <a href={githubUrl} target="_blank" rel="noopener noreferrer">
                  ...
                  <span className="max-md:hidden">{l.text('View on', { context: 'Prefix for a link to GitHub' })}</span> GitHub ↗
                </a>
              </Button>
            )}
                  ...
                  {typeof cookbook.author === 'string' ? (
                    <div className="flex items-center gap-2">
                      <span className="text-base text-foreground/50 font-mono font-medium">
                        {l.text('Written By', { context: 'Label before the cookbook author name' })}
                      </span>
